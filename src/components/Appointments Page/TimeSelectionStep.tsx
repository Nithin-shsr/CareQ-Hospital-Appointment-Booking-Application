...
function TimeSelectionStep({onBack,onTimeChange,onTypeChange,onDateChange,onContinue,selectedTime,selectedType,selectedDoctorId,selectedDate}:TimeSelectionStepProps){
